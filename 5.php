...
<h3><i>After reviewing your likes, we suggest you the following songs 

which you may like..</i></h3> 
...
$a=array("shreya goshal"=>"0","sonu nigam"=>"0","sunidhi 
...
google.visualization.PieChart(document.getElementById('piechart1_3d')
...
google.visualization.PieChart(document.getElementById('piechart2_3d')
...
{   
  ...
  $w=mysql_query("select * from songs WHERE artist='$key1' 

and song not in(select song from naive) limit 10"); 
             ...
             while($row=mysql_fetch_array($w)) 
                   ...
                   mysql_query("insert into display(song) 
                   ...
                   { 
                     ...
                     foreach($f as $r) 
                       ...
                       { 
                          ...
                          $poo=mysql_query("select * from songs where 

artist='$p' and genre='$q' and eras='$r' and song not in(select song 
...
{echo "<p></p>";echo "<p style='color:white;'>".$row['song']."<input 

type='checkbox' name='a[]'/></p>";} 
...
<i><p style='color:white;font­size:xx­large;text­align: 

center'>Survey of artist </p></i>; 

<div id="piechart_3d" style="width: 900px; height: 500px;"></div> 

<i><p style='color:white;font­size:xx­large;text­align: 

center'>Survey of genre</p></i>; 

<div id="piechart1_3d" style="width: 900px; height: 500px;"></div> 

<i><p style='color:white;font­size:xx­large;text­align: 

center'>Survey of eras</p></i>; 
